...
function scaleUpColumn(columnIndex) {
    ...
    cells.forEach(cell => {
        cell.addEventListener('mouseenter', () => {
            ...
            table.querySelectorAll(`th:nth-child(${columnIndex + 1}) source`).forEach(img => {
                [prefix] = img.srcset.split('_');
                img.srcset = `${prefix}_` + 'dark.png';
            })
    })
